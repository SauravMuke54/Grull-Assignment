...
import QuestRequest from '../QuestRequest/QuestRequest'
...
<div class="btn-group-vertical" role="group" aria-label="Vertical button group">
  ...
  <button type="button" class="btn btn-success m-1" onClick={e=>setFlag(2)}>Quest Request</button>
  <button type="button" class="btn btn-success m-1" onClick={e=>setFlag(3)}>My Profile</button>
