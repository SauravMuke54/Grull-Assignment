        ...
        <div className="col-lg-8 col-sm-12  " style={{ marginTop: "5%" }}>
          <div className="container-fluid border border-5 border-white p-5 rounded-5">
            ...
            <div class="form-group text-white mb-2">
              ...
              <div class="form-group text-white mb-2 mt-2">
                <label for="exampleInputPassword1"><h6>Profession</h6></label>
                <input
                  type="text"
                  class="form-control"
                  id="exampleInputPassword"
              ...
              <span className=" text-white"><h6>Already have an account?  <Link to="/user/signin">Signin</Link></h6>             </span>
              <span className=" text-white"><h6>Are you a community manageer?  <Link to="/community/signin">Go there</Link></h6>             </span>
