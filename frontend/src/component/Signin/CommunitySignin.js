...
export default function CommunitySignin() {
    ...
    const LoginHelper = async () => {
        ...
        try {
          await axios
            .post(`${BAPI}/community-manager/signin`, {
              email:email,
              password:password
            })
            .then((response) => {
  ...
  return (
    ...
    >
      ...
      <center><h1 className="text-white" style={{fontFamily:"cursive",marginTop:"4%",marginBottom:"0%"}}><b><u>Community Manager Login</u></b></h1></center>
      <center>
      {err && (
        ...
        <div className="col-lg-4 col-sm-12 " style={{ marginTop: "6%" }}>
         <center> <img className="img-fluid rounded-5" src='https://img.freepik.com/free-vector/login-concept-illustration_114360-739.jpg' /></center>
        </div>
        <div className="col-lg-8 col-sm-12  " style={{ marginTop: "6%" }}>
          <div className="container-fluid border border-5 border-white p-5 rounded-5">
            <div>
              ...
              <span className=" text-white"><h6>New User ?  <Link to="/community/signup">SignUp</Link></h6>
             </span>
              </div>
            </div>
          </div>
